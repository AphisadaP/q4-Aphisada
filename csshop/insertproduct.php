    ...
    <main>
        <article>
            <form action="product-insert.php" method="post" enctype="multipart/form-data">
                รหัสสินค้า : <input type="text" name="pid" required><br>
                ชื่อสินค้า : <input type="text" name="pname" required><br>
                รายละเอียดสินค้า : <br>
                <textarea name="pdetail" rows="3" cols="40" required></textarea><br>
                ราคา: <input type="number" name="price" min="0" step="0.01" required><br>
                รูปสินค้า: <input type="file" id="image_path" name="image_path" accept="image/jpg,image/jpeg,image/png"
                    required><br>
